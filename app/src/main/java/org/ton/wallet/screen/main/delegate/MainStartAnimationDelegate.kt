...
import org.ton.wallet.screen.activity.OnBoardingAnimationDelegate
import org.ton.wallet.screen.main.MainBottomSheetDrawable
import org.ton.wallet.screen.main.MainController
import kotlin.math.roundToInt

class MainStartAnimationDelegate {
    ...
    fun run(
        ...
        bottomSheetDrawable.setBitmap(MainController.BitmapForAnimation)
        bottomSheetDrawable.setTopOffset(0f)
        rootView.foreground = bottomSheetDrawable
        MainController.BitmapForAnimation = null

        val targetOffset = Res.dimen(R.dimen.splash_bottom_sheet_top)
        ...
        screenAnimator = ValueAnimator.ofFloat(0f, 1f).apply {
            ...
            OnBoardingAnimationDelegate.applyAnimatorProperties(this)
        }
