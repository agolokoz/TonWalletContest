...
object Res {
    ...
    private val displayMetrics = threadLocal { DisplayMetrics() }
    private val tlTypedValue = threadLocal { TypedValue() }
    ...
    private var scaledDensity = Resources.getSystem().displayMetrics.scaledDensity
