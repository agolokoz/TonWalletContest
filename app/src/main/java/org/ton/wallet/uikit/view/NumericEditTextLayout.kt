...
class NumericEditTextLayout @JvmOverloads constructor(
    ...
    init {
        numberTextPaint.color = Res.color(R.color.text_secondary)
        numberTextPaint.typeface = Res.font(R.font.roboto_regular)
        numberTextPaint.textSize = editText.paint.textSize
        descentAscentDiff = numberTextPaint.descent() + numberTextPaint.ascent()
        ...
        clearImage.imageTintList = ColorStateList.valueOf(ColorUtils.setAlphaComponent(Res.color(R.color.text_secondary), 127))
        clearImage.isVisible = false
        clearImage.setBackgroundResource(R.drawable.ripple_oval_dark)
        clearImage.scaleType = ImageView.ScaleType.CENTER
        clearImage.setImageResource(R.drawable.ic_clear_16)
