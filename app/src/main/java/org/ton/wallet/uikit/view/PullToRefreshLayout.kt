...
class PullToRefreshLayout @JvmOverloads constructor(
    ...
    private class PullDrawable : Drawable() {
        ...
        private val activeArrowBitmap = Res.drawableBitmap(Res.drawableColored(R.drawable.ic_arrow_pull, Res.color(R.color.pull_to_refresh_foreground)))
        private val inactiveArrowBitmap = Res.drawableBitmap(Res.drawableColored(R.drawable.ic_arrow_pull, Res.color(R.color.pull_to_refresh_background)))
        private val arrowMatrix = Matrix()
        private val swipeString = Res.str(R.string.swipe_down_to_refresh)
        private val releaseString = Res.str(R.string.release_to_refresh)
        ...
        init {
            inactivePaint.color = Res.color(R.color.pull_to_refresh_background)
            activePaint.color = Res.color(R.color.pull_to_refresh_foreground)
            linePaint.color = Res.color(R.color.common_white)
            textPaint.color = Res.color(R.color.common_white)
            textPaint.typeface = Res.font(R.font.roboto_medium)
