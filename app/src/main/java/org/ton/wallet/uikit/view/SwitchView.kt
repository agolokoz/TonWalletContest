...
class SwitchView @JvmOverloads constructor(
    ...
    companion object {
        ...
        private val ColorCircle = Res.color(R.color.common_white)
        private val ColorDisabled = Res.color(R.color.toggle_disabled)
        private val ColorEnabled = Res.color(R.color.toggle_enabled)
