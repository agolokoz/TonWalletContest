...
class CheckBoxTextView @JvmOverloads constructor(
    ...
    private class CheckBoxDrawable(
        ...
        private val checkBitmap = Res.drawableBitmap(Res.drawableColored(R.drawable.ic_check_18, Res.color(R.color.common_white)))
        ...
        init {
            enabledPaint.color = Res.color(R.color.blue)
            disabledPaint.color = Res.color(R.color.toggle_disabled)
            foregroundPaint.color = Res.color(R.color.common_white)
        }
