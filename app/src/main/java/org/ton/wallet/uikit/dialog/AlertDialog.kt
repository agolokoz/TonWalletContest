...
class AlertDialog private constructor(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val contentLayoutDrawable = Res.drawable(R.drawable.popup_fixed_alert)
        ...
        contentLayout.background = Res.drawable(R.drawable.popup_fixed_alert)
        ...
        titleView.setTextColor(Res.color(R.color.text_primary))
        titleView.setTextSize(TypedValue.COMPLEX_UNIT_SP, 19f)
        titleView.typeface = Res.font(R.font.roboto_medium)
        ...
        messageView.setTextColor(Res.color(R.color.text_primary))
